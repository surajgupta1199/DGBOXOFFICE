                           ...
                           <div class="row">
                              ...
                              <div class="col-sm-6 form_gallery form-group">
                                 ...
                                 <input data-name="#add_banner" name="series_banner" id="add_form_gallery-upload" class="form-control form_gallery-upload"
                                    type="file" accept=".png, .jpg, .jpeg" onchange="UploadUrl(this,'add_view_img_0');" required>
                                 <div class="fileupload_img"><img type="image" id="add_view_img_0" src="<?php echo base_url('assets/assets/images/dashboard/03.jpg'); ?>"style="height: 200px" alt="Featured image" /></div>
                              </div>
                              <div class="col-sm-6 form_gallery form-group">
                                 ...
                                 <div class="fileupload_img"><img type="image" id="post_add_view_img" src="<?php echo base_url('assets/assets/images/dashboard/03.jpg'); ?>"style="height: 200px" alt="Featured image" /></div>
                              </div>
                              <div class="col-sm-6 form-group">
                              ...
                              <div class="col-sm-6 form-group">
                                 <input type="text" name="season_number" class="form-control" placeholder="Enter Season Number" required>
                              </div>
                              <div class="col-sm-6 form-group">
