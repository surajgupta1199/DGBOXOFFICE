                        ...
                        <form id="add_movie">
                           <div class="row">
                              ...
                              <div class="col-sm-6 form_gallery form-group">
                                 <label id="add_banner" for="add_form_gallery-upload">Upload Banner Image</label>
                              ...
                              <div class="col-sm-6 form_gallery form-group">
                                 ...
                                 <input data-name="#post_add_banner" name="movie_poster" id="post_form_gallery-upload" class="form-control form_gallery-upload"
                                    type="file" accept=".png, .jpg, .jpeg" onchange="UploadUrl(this,'post');" required>
                              ...
                              <div class="col-sm-6 form-group">
                                 <input type="text" name="director" placeholder="Enter Director Name" class="form-control" required>
                              </div>
                           </div>
                           <hr>
                            <div class="row">
                              ...
                              <div class="col-sm-6 form-group">
                                 <textarea id="synopsis" name="synopsis" rows="3" class="form-control"
                                    placeholder="Synopsis"></textarea>
                              </div>
                              <div class="col-sm-6 form-group">
                                 <textarea id="description" rows="3" name="description" class="form-control"
...
<script>
   ...
   function UploadUrl(input,add_edit) {
      var add_edit_1 = add_edit == "add" ? "add_view_img" : "post_add_view_img";
