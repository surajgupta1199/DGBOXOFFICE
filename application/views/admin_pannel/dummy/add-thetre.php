                  ...
                  <div class="iq-card">
                     <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                           <h4 class="card-title">Add Thetre</h4>
                        </div>
                     </div>
                     <div class="iq-card-body">
                        <form id="add_movie">
                           <div class="row">
                              ...
                              <div class="col-sm-6 form-group">
                                 <input type="url" name="movie_trail_link" class="form-control" placeholder="Thetre trailer link" required>
                              </div>
                              <div class="col-sm-6 form-group">
                                 <input type="url" name="movie_link" class="form-control" placeholder="Thetre link" required>
                              </div>
                              <div class="col-sm-6 form-group">
                                 <input type="text" class="form-control" name="total_duration" placeholder="Thetre Duration" required>
                              </div>
                              <div class="col-sm-6 form-group">
                           ...
                           <hr>
                            <div class="row">
                              <div class="col-6">
                                 <h5 class="text-white mb-3">Thetre Synopsis</h5>
                              </div>
                              <div class="col-6">
                                 <h5 class="text-white mb-3">Thetre writer</h5>
                              </div>
                              <div class="col-sm-6 form-group">
                              ...
                              <div class="col-6">
                                 <h5 class="text-white mb-3">Thetre Director</h5>
                              </div>
                              <div class="col-6">
                                 <h5 class="text-white mb-3">Thetre Cast</h5>
                              </div>
                              <div class="col-sm-6 form-group">
                              ...
                              <div class="col-6">
                                 <h5 class="text-white mb-3">Thetre Genres</h5>
                              </div>
                              <div class="col-6">
                                 <h5 class="text-white mb-3">Thetre Description</h5>
                              </div>
                              <div class="col-sm-6 form-group">
