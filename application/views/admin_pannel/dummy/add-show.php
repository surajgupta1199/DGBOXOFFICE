                        ...
                        <form id="add_series">
                           <div class="row">
                              <div class="col-md-6 form-group">
                                 <input type="text" name="series_name" class="form-control" placeholder="Title" required>
                              </div>
                              <div class="col-md-6 form-group">
                           ...
                           <div class="row">
                              ...
                              <div class="col-sm-6 form-group">
                                 <input type="text" class="form-control" name="total_duration" placeholder="Series Duration" required>
                              </div>
                              <div class="col-md-6 form-group">
                           ...
                           <div class="row" id="hide_data" style="display: none;">
                              ...
                              <div class="col-6">
                                 <h5 class="text-white mb-3">Series Genres</h5>
                              </div>
                              <div class="col-6">
                                 <h5 class="text-white mb-3">Description</h5>
                              </div>
                              <div class="col-sm-6 form-group">
                                 <input id="genres" rows="5" name="series_genres" class="form-control"
                                    placeholder="Genres" >
                              </div>
                              <div class="col-sm-6 form-group">
...
<script type="text/javascript">
   ...
   $('#add_series').submit(function(e){
      ...
      form.append('series_writer',series_writer.getData());
      form.append('series_director',series_director.getData());
      form.append('series_cast',series_cast.getData());
      form.append('series_genres',series_genres.getData());
